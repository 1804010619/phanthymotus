        ...
        'tools': [
            {
                ...
                'configSchema': {
                    ...
                    'properties': {
                        ...
                        'narration_silence_rounds': {'type': 'integer', 'description': '主动播报：连续多少轮没对用户说话后自动汇报一次进展（0 = 关闭）', 'default': 4, 'x-show-when': {'auto_notify': 'true'}},
                        'narration_silence_seconds': {'type': 'integer', 'description': '主动播报：距上次对用户说话多少秒后自动汇报（0 = 关闭）。与轮数先到者生效', 'default': 25, 'x-show-when': {'auto_notify': 'true'}},
