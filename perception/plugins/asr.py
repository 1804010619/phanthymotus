...
TOOLS = [
    {
        ...
        "configSchema": {
            ...
            "properties": {
                ...
                "hw_provider":   {"type": "string", "enum": ["cuda", "cpu"], "description": "sherpa-onnx 推理后端", "default": "cpu", "scope": "shared", "x-show-when": {"provider": "sherpa_onnx"}},
                "num_threads":   {"type": "integer", "description": "sherpa-onnx 推理线程数", "default": 2, "scope": "shared", "x-show-when": {"provider": "sherpa_onnx"}},
